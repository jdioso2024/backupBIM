        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-3">
                <a href="{{ route('admrektorat.dashboard') }}"
                    class="inline-flex justify-center mt-2 py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full sm:w-auto">Kembali</a>
            </div>
            <div class="grid grid-cols-1">
                <div class="overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6">
                        <form method="GET" action="{{ route('admrektorat.kip.dashboard') }}"
                        ...
                        <form action="{{ route('admrektorat.kip.dashboard') }}" method="get">
                            <div class="flex mt-2">
                                <button type="submit"
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <form action="{{ route('admrektorat.kip.export.student') }}" method="get"
                    ...
                    <form method="GET" action="{{ route('admrektorat.kip.dashboard') }}" class="mb-4 w-full sm:w-auto">
                        <div class="mb-4 sm:mb-0">
                            ...
                            <tbody>
                                @forelse ($students as $student)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($student->program->id == 1 && $student->user->hasPermissionTo('kip'))
                                                <p class="bg-blue-600 rounded-lg text-white px-2 text-center">KIP</p>
                                            @else
                                                <p class="bg-teal-600 rounded-lg text-white px-2 text-center">NOT KIP
                                                </p>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($slipTransfer)
                                                <button data-modal-target="default-modal"
                                                    ...
                                                    data-image-url="{{ $slipTransfer->getUrl() }}"
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($student->status == 0 && $slipTransfer !== null)
                                                @if ($slipTransfer->getUrl())
